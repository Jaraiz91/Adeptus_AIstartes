...
from ai_assistant.graph import graph_builder
from ai_assistant.modules.speech import SpeechToText, TextToSpeech
...
async def whatsapp_handler(request: Request) -> Response:
    ...
    try:
        ...
        if "messages" in change_value:
            ...
            workflow = output_state.values.get("workflow", "texto")
